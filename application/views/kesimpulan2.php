...
<section class="content">
  <div class="row">
  <form action="<?=base_url('admin2/kesimpulan');?>" method="post">
...
<div class="row">
      ...
      <a href="<?=base_url('export/kesimpulan2/xlsx/'.$datetime.'/'.$datetime2);?>" class="pull-left btn btn-default">Excel <i class="fa fa-file-excel-o"></i></a>
      <?php 
  ...
  <tr>
    ...
    <td><?php
	//if(!empty($this->data2_model->get_by_kesimpulan($value->id,$datetime,$datetime2)->row()->rata)){
		echo round($this->data2_model->get_by_kesimpulan($value->id,$datetime,$datetime2)->row()->rata,3);
	//}
	?>
	</td>
    <td><?php
	if(!empty($this->data2_model->get_by_kesimpulan($value->id,$datetime,$datetime2)->row()->rata)){
	echo $this->data2_model->get_kesimpulan_rata($this->data2_model->get_by_kesimpulan($value->id,$datetime,$datetime2)->row()->rata)->row()->value2;
	}
	?>
	</td>
  </tr>
